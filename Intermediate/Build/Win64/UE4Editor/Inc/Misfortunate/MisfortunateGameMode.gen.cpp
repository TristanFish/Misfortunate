...
// Cross Module References
	MISFORTUNATE_API UEnum* Z_Construct_UEnum_Misfortunate_UGameState();
...
// End Cross Module References
	static UEnum* UGameState_StaticEnum()
	{
		static UEnum* Singleton = nullptr;
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Misfortunate_UGameState, Z_Construct_UPackage__Script_Misfortunate(), TEXT("UGameState"));
		}
		return Singleton;
	}
	template<> MISFORTUNATE_API UEnum* StaticEnum<UGameState>()
	{
		return UGameState_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_UGameState(UGameState_StaticEnum, TEXT("/Script/Misfortunate"), TEXT("UGameState"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Misfortunate_UGameState_Hash() { return 2819250940U; }
	UEnum* Z_Construct_UEnum_Misfortunate_UGameState()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Misfortunate();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("UGameState"), 0, Get_Z_Construct_UEnum_Misfortunate_UGameState_Hash(), false);
#else
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMisfortunateGameMode_Statics::NewProp_CurrentState_MetaData[] = {
		{ "Category", "MisfortunateGameMode" },
		{ "ModuleRelativePath", "Public/MisfortunateGameMode.h" },
	};
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_AMisfortunateGameMode_Statics::NewProp_CurrentState = { "CurrentState", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMisfortunateGameMode, CurrentState), Z_Construct_UEnum_Misfortunate_UGameState, METADATA_PARAMS(Z_Construct_UClass_AMisfortunateGameMode_Statics::NewProp_CurrentState_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMisfortunateGameMode_Statics::NewProp_CurrentState_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMisfortunateGameMode_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMisfortunateGameMode_Statics::NewProp_CurrentState,
	...
	IMPLEMENT_CLASS(AMisfortunateGameMode, 615635487);
